...
// ĐÃ XÓA: import org.slf4j.Logger; và LoggerFactory

public class Bank {
    // ĐÃ XÓA: Khai báo logger
        ...
        try (BufferedReader reader = new BufferedReader(new InputStreamReader(inputStream))) {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                if (token.matches("\\d{9}")) { // TODO: đưa regex vào hằng số
                    ...
                    // ĐÃ SỬA: Thay logger.info bằng System.out.println
                    System.out.println("Thêm khách hàng: " + name);
                    ...
                    if (parts.length >= 3) {
                        ...
                        switch (parts[1]) {
                            ...
                            case "SAVINGS":
                                ...
                                break;
                            default:
                                // ĐÃ SỬA: Thay logger.warn bằng System.out.println
                                System.out.println("Loại tài khoản không hợp lệ: " + parts[1]);
                        }
                    }
                }
            }
        } catch (IOException e) {
            // ĐÃ SỬA: Thay logger.error bằng System.out.println
